...
class LSM9DS1Class {
  public:
    ...
    virtual int readAccelerationMultiple(float& ax, float& ay, float& az, int n);
    virtual int readAccelerationGyroMultiple(float& ax, float& ay, float& az, float& gx, float& gy, float& gz, int n);
    virtual int readAccelerationMultipleY(float& ay, int n);
